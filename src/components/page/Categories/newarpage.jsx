...
const NewarPage = () => {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:8000/newari/")
      .then((response) => {
    ...
    <>
      ...
      <div className="py-6 bg-gradient-to-b from-pink-100 to-white-100-100">
        <div className="max-w-screen-xl mx-auto px-4 text-start">
          <h1 className="text-4xl md:text-5xl font-bold">Newari Dress</h1>
          <p className="mt-4 text-lg md:text-xl text-gray-700">
            "Timeless beauty and tradition, beautifully expressed through Newar dress."
          </p>
        </div>
        ...
        <div className="py-10 max-w-screen-xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-700">
            Discover the latest additions to our collection of traditional attire, showcasing the rich heritage and unique styles of various cultures.
          </p>
        ...
        <div className="py-10 max-w-screen-xl mx-auto px-4 text-start">
          ...
          <div className="flex justify-between items-center">
            <p className="mt-4 text-lg md:text-xl text-gray-700">
              Explore our newest additions to the Newar collection
            </p>           
          </div>
          <div className="flex flex-wrap  gap-16 py-10">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-10 flex items-center gap-20">
          ...
          <div className="w-full md:w-1/2 px-4">
            ...
            <p className="mt-4 text-lg md:text-xl text-gray-700">
              Discover the vision and inspiration behind our Newar collection. Get an inside look at the artistry and dedication of our designers.
            </p>
          </div>
        </div>
         {/* Footer Section */}
