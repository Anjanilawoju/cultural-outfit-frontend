...
const ProductDisplay = ({ image, productName, price, discount, product_id, rating, freeDelivery }) => {
    ...
    return (
        <div className="w-64 shadow-lg p-4 bg-white rounded-lg relative">
            ...
            {/* Product Information */}
            <h3 className="text-base font-semibold mb-1 text-center">{productName}</h3>
            ...
            {/* Price Section */}
            <div className="text-red-500 text-xl font-bold text-center mb-4">Rs.{price}</div>
